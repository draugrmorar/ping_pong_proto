...
const (
	Ping_Ping_FullMethodName = "/pingpong.Ping/Ping"
)
...
func (c *pingClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongResponse, error) {
